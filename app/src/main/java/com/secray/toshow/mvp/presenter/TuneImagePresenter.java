...
public class TuneImagePresenter implements TuneImageContract.Presenter {
    TuneImageContract.View mView;
    private String mPath;

    @Inject
    public TuneImagePresenter() {

    }

    @Override
    public void bindView(TuneImageContract.View view) {
        mView = view;
    }
