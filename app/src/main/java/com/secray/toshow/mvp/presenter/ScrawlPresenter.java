...
public class ScrawlPresenter implements ScrawlContract.Presenter {
    ScrawlContract.View mView;
    private String mPath;

    @Inject
    public ScrawlPresenter() {

    }

    @Override
    public void bindView(ScrawlContract.View view) {
        mView = view;
